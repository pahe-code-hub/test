...
* Betroffene Rollen: `research_v1` (verarbeitet Rohinhalte direkt aus `extract`), `architect_v1`, `challenger_v1`, `critic_v1` (erhalten die Research-Zusammenfassung als Kontext).
